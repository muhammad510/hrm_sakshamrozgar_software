...
/*                $status = ($row->status == 1) ? '
        ...
        public function add_shift_data() {
            ...
            if($this->form_validation->run() == TRUE) {
				...
				$grace_periods=$add['graceP']?$add['graceP']:'0';
                $shift = array(
        ...
        public function update_shift() {
            ...
            $data['update_shift']=$this->common->get_data('shift_manage',array('id'=>$update['id']),'id,shift_name,shift_duration,shift_start,shift_end,grace_periods,status');
