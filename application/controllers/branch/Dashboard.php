...
/*	echo'<pre>';
	...
	/*-------------------------------Holiday Manage End----------------------------*/
		...
		$data=array('tEmpPresent'=>$tEmpPresent,'tEmpLate'=>$tEmpLate,'tEmpAbsent'=>$tEmpAbsent,'tEmpHfDy'=>$tEmpHfDy,'tEmpLeave'=>$tEmpLeave,'totalEmp'=>$totalEmp,
					...
					'resigned'=>$resigned,'isNewEmp'=>$isNewEmp,'employee'=>$employee,'thisMonthSalary'=>$thisMonthSalary,'thisMonthHoliday'=>$thisMonthHoliday,'recentJoinee'=>$recentJoinee,
					'recentTurnover'=>$recentTurnover,'todayAttendance'=>$todayAttendance,'empUpComingBdy'=>$empUpComingBdy,'title'=>'Dashboard Panel','breadcrums'=>'Dashboard Panel',
