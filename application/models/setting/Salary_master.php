...
class Salary_master  extends CI_Model
{
    ...
    public function salary_query($where = false)
    {
        ...
        if (!empty($where['grossAmt'])) {
            $this->db->where('sm.gross_sal_amt', $where['grossAmt']);
        }
