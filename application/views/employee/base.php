...
<head>
	...
	.bg-primary-mi {background: rgba(51, 102, 255, 0.25);color: #3164fd !important;}
	...
	.bg-pink-mi{background: rgba(239, 78, 184, 0.25);color: #ef4eb8 !important;}
                ...
                <div class="main-container container-fluid">
					...
					?>   
						...
						<!--<div class="page-header">
							<div><h2 class="main-content-title tx-24 mg-b-5">Welcome to employee dashboard</h2></div>
							<div class="d-flex">
  ...
  <div class="page-rightheader mt-0 mt-xxl-0">
                                   <div class="d-flex align-items-center flex-wrap my-auto end-content breadcrumb-end gap-1">
                                      <a href="javascript:void(0);" class="btn btn-primary me-2 my-md-0 my-1" data-bs-toggle="modal" data-bs-target="#applyleaves">
                                        ...
                                        <div class="d-flex flex-wrap gap-2" style="background-color:#999999;width:18.9rem;margin-right: 8px;height: 2.3rem;">
                                          <!-- <div class="header-datepicker"> 
                                                <div class="form-group mb-0"> 
                                                    <div class="input-group">
                                                         <div class="input-group-text"> <i class="fe fe-calendar"></i> </div> 
                                                         <input type="text" class="form-control" placeholder="19 Feb 2020" readonly="readonly"> 
                                                     </div>
                                                 </div> 
                                            </div> 
                                           <div class="header-datepicker me-2"> 
                                                <div class="form-group mb-sm-0"> 
                                                    <div class="input-group"> 
                                                        ...
                                                        <div class="form-control">09:30am</div> 
                                                     </div>
                                                 </div> 
                                             </div>-->
                                             
                                             Date and Time will show here
                                             
                                           <!-- wd-150 -->
                                        </div> 
                                        <div class="d-flex gap-2"> 
                                            <button class="btn  ripple fntMi btn-outline-success " data-bs-toggle="modal" data-bs-target="#clockinmodal"><i class="fe fe-sunrise"></i> Clock In</button>
...
<!--------------------------------------@mit Emp Dashboard End------------------------------------------------->                           
                        ...
                        <div class="row row-sm">
							...
							<div class="col-sm-12 col-lg-12 col-xl-4 mt-xl-4">
								<div class="card custom-card overflow-hidden"> <div class="card-header border-0"> <h4 class="card-title">Recent Activity</h4> </div> <div class="pt-3"> <div class="table-responsive card-table-one"> <table class="table transaction-table mb-0 text-nowrap"> <tbody><tr><td class="d-flex ps-4"> <span class="bg-pink pink-border rounded-circle d-block me-3 mt-1 h-5 w-5"></span> <div class="my-auto"> <span class="mb-1 fw-medium fs-16">You Late to day</span> <div class="clearfix"></div> <small class="text-muted fs-14">Your office intime is 9:42</small> <div class="clearfix"></div> <small class="text-muted fs-14">Late time 14min</small> </div> </td><td> <div class="text-end pe-4"> <a class="text-muted d-block fs-16" href="javascript:void(0);">Just Now</a> </div> </td></tr><tr><td class="d-flex ps-4"> <span class="bg-warning warning-border rounded-circle d-block me-3 mt-1 h-5 w-5"></span> <div class="my-auto"> <span class="mb-1 fw-medium fs-16">Below for those interested</span> <div class="clearfix"></div> <small class="text-muted fs-14">Undoubtable source</small> </div> </td><td> <div class="text-end pe-4"> <a class="text-muted d-block fs-16" href="javascript:void(0);">1 Hour ago</a> </div> </td></tr><tr><td class="d-flex ps-4"> <span class="bg-primary primary-border rounded-circle d-block me-3 mt-1 h-5 w-5"></span> <div class="my-auto"> <span class="mb-1 fw-medium fs-16">Success! your Lunch Time</span> <div class="clearfix"></div> <small class="text-muted fs-14">Lunch time 1:30 To 2:30</small> </div> </td><td> <div class="text-end pe-4"> <a class="text-muted d-block fs-16" href="javascript:void(0);">4 hours ago</a> </div> </td></tr><tr><td class="d-flex ps-4"> <span class="bg-success success-border rounded-circle d-block me-3 mt-1 h-5 w-5"></span> <div class="my-auto"> <span class="mb-1 fw-medium fs-16">Many desktops Publishing The</span> <div class="clearfix"></div> <span class="mb-1 fw-medium fs-16"> versions are evolved</span> <div class="clearfix"></div> <small class="text-muted fs-14">Page editors now use...</small> <div class="clearfix"></div> <small class="text-muted fs-14">Late time 14min</small> </div> </td><td> <div class="text-end pe-4"> <a class="text-muted d-block fs-16" href="javascript:void(0);">5 hours ago</a> </div> </td></tr><tr><td class="d-flex ps-4"> <span class="bg-orange orange-border rounded-circle d-block me-3 mt-1 h-5 w-5"></span> <div class="my-auto"> <span class="mb-1 fw-medium fs-16">Below for those interested</span> <div class="clearfix"></div> <small class="text-muted fs-14">Birthday on Feb 16</small> </div> </td><td> <div class="text-end pe-4"> <a class="text-muted d-block fs-16" href="javascript:void(0);">11 Jan 2020</a> </div> </td></tr> </tbody></table> </div> </div> </div>
	...
	<p>Keep Enjoying [Your Software Name],<br> [Your Company Name]</p>
       ...
       <?php $this->load->view('employee/include/js');if(!($isCheck <= $isExpired)){?>
	   		<style>#renwContinue i{ font-size: 12px;}#target{ display:none;} .licnce{ margin:-20px;}#errKey{display:none;color:#cc4300;float: right;margin-top:-60px;}
