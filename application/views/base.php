...
<!-- FAVICON -->
<style>
 #miArvClk{font-weight: 500;}
.expApproved {background-color: #168400 !important;color: #ffffff !important;}
.expPaidOut {background-color: #5C10CC !important;color: #ffffff !important;}
.expReject {background-color: #f16d75 !important;color: #ffffff !important;}
.expPending {background-color: #FFAE01 !important;color: #ffffff !important;}
        ...
        <div class="ami_toast tst_warning" style="top:72px;"><i class="bx bx-error"></i> ami popup notification</div>
          <div class="rgt_notify tSuccess">
               <ul>
                    ...
                    <li><div class="spinrGlow dngr"></div> @mi notify on right top corner</li>
                    <li><div class="spinrGlow deflt"></div> @mi notify on right top corner</li>
                    <li><div class="spinrGlow wrng"></div> @mi notify on right top corner</li>
                </ul>
            </div>
        <?php
                      ...
                      <p class="mb-0 mt-4 text-primary">
                        ...
                        <sup class="spInc">March</sup>
                      	<span class="float-end">
                        	<?php $thisMonthEmp=$loggedAtt['newJoinee']?round(($loggedAtt['newJoinee']*100/$totalEmp),2):'0';echo $thisMonthEmp;?>%
                        </span>
                      </p>
                    </div>
                  </div>
...
<!--------------------------------------------------------------------------------------------------------------------->            
  ...
  <style>.item {width: 248px;}.text-hfDy{color:#D9AD03;}.text-absnt{color:#F16D75;}.text-leave{color:#009EA6;}.text-late{color:#CC7000;}</style>          
            <div class="row row-sm">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                               <a href="<?php echo base_url('admin/attendance/daily');?>" class="text-white"> 
                                    <div class="d-flex no-block align-items-center">
                                        <div><span class="text-muted tx-13 mb-3">Present Employees</span><h3 class="m-0 mt-2 text-success"><?php echo $tEmpPresent;?></h3></div>
                                        <div class="ms-auto mt-auto">
...
<!--------------------------------------------------------------------------------------------------------------------->          			
			...
			//	exit;
			  	if($todayAttendance)
				   { 
					...
					{
						if($att->attendance_status=='1'){$attSign='fas fa-level-up-alt ms-2 text-success m-l-10';}
						else if($att->attendance_status=='2'){$attSign='fas fa-level-down-alt ms-2 text-danger m-l-10';}
						else{$attSign='fas fa-level-down-alt ms-2 text-danger m-l-10';}
                      ...
                      <tr>
                        ...
                        <td><div class="d-flex align-middle ms-3">
                            <div class="d-inline-block"><h6 class="mb-1"><?php echo $employeeNm;?></h6>
                              <p class="mb-0 tx-13 text-muted"><?php echo $att->designation_name;?></p>
                            </div>
                          </div></td>
                        <td class="text-end"><div class="d-inline-block">
                ...
                <h5 class="card-title mb-btm">Today's Statistics</h5>
                 <div class="stats-list">
                  <div class="stats-info">
                    ...
                    <div class="progress"><div style="width:<?php echo $prsntPr;?>%; background-color:#17a602;"> &nbsp;</div></div>
                  </div>
                  <div class="stats-info">
                    <p> Late <strong><?php echo $tEmpLate;?> <small>/ <?php echo $totalEmp;?></small></strong></p>
                    <div class="progress"><div style="width:<?php echo $latePr;?>%; background-color:#e1680f;"> &nbsp;</div></div>
                  </div>
                  <div class="stats-info">
                    <p> Absent <strong><?php echo $tEmpAbsent;?> <small>/ <?php echo $totalEmp;?></small></strong></p>
                    <div class="progress"><div style="width:<?php echo $absntPr;?>%; background-color:#e7183a;"> &nbsp;</div></div>
                  </div>
                  <div class="stats-info">
                    <p> Half Day <strong><?php echo $tEmpHfDy;?> <small>/ <?php echo $totalEmp;?></small></strong></p>
                    <div class="progress"><div style="width:<?php echo $halfDyPr;?>%; background-color:#e3b113;"> &nbsp;</div></div>
                  </div>
                  <div class="stats-info">
                    <p> Leave <strong><?php echo $tEmpLeave;?> <small>/ <?php echo $totalEmp;?></small></strong></p>
                    <div class="progress"><div style="width:<?php echo $leavePr;?>%; background-color:#009EA6;"> &nbsp;</div></div>
                  </div>
                </div>
              </div>
            </div>
                 ...
                 <div class="birthdy"> 
                   <?php
					 if($empUpComingBdy)
					 {
					   ...
					   {
							$dob=new DateTime($bdy->dob);$today=new DateTime('today');$year=$dob->diff($today)->y;$month=$dob->diff($today)->m;
							$day = $dob->diff($today)->d;if($year=='1'){$year=$year.' Year old';}else{$year=$year.' Years old';}
							$nDy=date('Y').'-'.date('m-d',strtotime($bdy->dob));
							if($nDy >date('Y-m-d'))
							{
								 $dayDiff=abs(round((strtotime($nDy)-strtotime(date('Y-m-d')))/86400)); 
								 if($dayDiff=='1'){$ndyLeft='<span>'.$dayDiff. ' day to left</span>';}else{$ndyLeft='<span>'.$dayDiff. ' days to left</span>';}
								}else{$ndyLeft='<span style="color:#d0c301;font-size:11px;padding-right:5px;">Birthday gone</span>';}
							...
							{$bdyBtn='<span class="badge bg-inverse-success pull-right"><i class="ti-gift"></i> Wish Now</span>';}
								else{$bdyBtn='<span class="badge bg-yr pull-right">'.$year.'</span>';}
            ...
            <div class="card flex-fill">
              <div class="card-body">
                <h5 class="card-title mb-btm">This Month Holiday </h5>
                    <div <?php if( count($thisMonthHoliday) >4){?> class="hldy" <?php }else { echo 'class="thisMonthH"';}?>>
                          <?php
                                        if($thisMonthHoliday)
                                        {
                                            $noClrCnt=0;$clrNotifyArr=array('mi-success-transparent','mi-purple-transparent','mi-warning-transparent','mi-pink-transparent');
                   ...
                   <ul class="top-selling-products pb-0 mb-0 px-0">
                    <?php
                         if($recentJoinee)
                        {
                         ...
                         {
                            if($recent->salary_type=='1'){$salary=$recent->salary_amount*26;}
                            else if($recent->salary_type=='2'){$salary=$recent->salary_amount*26/7;}
                            else{$salary=$recent->salary_amount;}
              ...
              <div class="modal-body tx-center pd-y-20 pd-x-20">
                <div id="renwMsg"> <i class="icon ion-ios-power tx-100 tx-danger lh-1 mg-t-20 d-inline-block"></i>
                  ...
                  <a href="<?php echo base_url('auth/login/signout'); ?>" id="renwContinue"
												class="btn ripple btn-success amiBtnActn"> Continue <i class="si si-arrow-right-circle"></i> </a> </div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="main-footer text-center" style="position:fixed;left:0;bottom:0;width:100%;">
    <div class="container">
      <div class="row row-sm">
        <div class="col-md-12"> <span>Copyright © 2023 <a href="#"> <?php echo config_item('company_name'); ?> </a>. Designed by <a href="http://www.facebook.com/amisingh143"> <?php echo config_item('dev_name'); ?> </a> All rights reserved.</span> </div>
      </div>
    </div>
  </div>
  <!-- END FOOTER -->
...
$this->curent=$this->router->fetch_class();
 $this->load->view('include/js');
	if (!($isCheck <= $isExpired)) { ?>
<style>
			#renwContinue i {font-size: 12px;}#target {display: none;}.licnce {margin: -20px;}#errKey {display: none;color: #cc4300;float: right;margin-top: -60px;}
		</style>
<script>
			$(document).ready(function () {
