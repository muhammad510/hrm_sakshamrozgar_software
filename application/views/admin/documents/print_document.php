...
.mClose{margin:-10px -10px 0px 0px !important;}
.slipImg img {width: 100%; padding-top:20px;}
...
.letter-content {margin-top: 20px;font-size: 15px;text-align: justify;}
.signature {margin-top: 30px;font-weight: bold;}
.signature p{ margin:5px 0px -5px 0px !important;}
.wrningLtr{ margin-top:80px;}

.parent{display: flex;font-weight: 700;text-align: center;text-transform: uppercase;font-size: 1.25rem;border-top: 1px solid #e3e3e3;padding-top: 10px;}
...
.child-2 {width: 50%; }
.child-3 {width: 25%;text-align:right;font-weight: lighter;font-size: .75rem;padding-top: 17px;}

.offrHdrImg{ margin-top:-35px;}
...
#downloadForOffrFrm{ display:none}
