...
<div class="row row-sm">
  <div class="cardTtl">
    ...
    <!--<span class="miBck"><a href="javascript:void(0);" class="srchPanel" id="srchBtn"  title="Click to search details"><i class="ti-search"></i></a></span>-->
    <span class="miBck"><a href="<?php echo $bckUrl; ?>"><i class="ti-arrow-left"></i></a></span> </div>
    <div class="col-md-12 col-lg-12">
      <?php	
					/*$myStr='EMP457550';$result=substr($myStr, 3,6);echo $result.'<br>';*/
		/*$currentTime=date('H:i:s');
		$getCurShift=$this->common->get_data('shift_manage',array('shift_start <'=>$currentTime,'shift_end >'=>$currentTime),'*');
		echo $this->db->last_query().'<br>';
		echo $currentTime.'<br>';
		print_r($getCurShift);*/
		//$currentTime=$employee_data['shift_start'sss]?date('H:i:s',strtotime($employee_data['shift_start'])):date('H:i:s');
		//print_r($testMode);
					?>
	  ...
	  <div id="mkAttendance" style="display:none; min-height:450px;">
	  		<form id="attendance_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="row row-sm">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control miDtTimePicker" name="atLogIn" id="atLogIn" value="<?php echo date('h:i:s d-m-Y') ?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control miDtTimePicker" name="atlogOut" id="atlogOut" value="<?php echo date('h:i:s d-m-Y',strtotime('+8 hours')) ?>">
                    </div>
                  </div>
                </div>
