...
.appointment-letter {
	padding:30px 20px;font-size: 12px;td {padding:5px 10px;border: 1px solid #d9d9d9;font-size:11px;}
table {
	width:100%
}
              ...
              <div class="appointment-letter">
               ...
               <div style="text-align:justify">
                ...
                <table>
                    ...
                    <tr><td style="width:40%">Department </td><td colspan="2"><span class="myFontBg empDepartment" style="text-transform:uppercase;"></span></td></tr>
                    <tr><td style="width:40%">Date of Joining </td><td colspan="2"><span class="myFontBg dtEmpJoin"></span></td></tr>
                    <tr><td style="width:40%">Remarks </td><td colspan="2"></td></tr>
                    <tr class="baComponent"><td style="width:40%">SALARY COMPONENTS </td><td>INR PER MONTH</td><td>INR PER ANNUM</td></tr>
                    <tr><td style="width:40%">Basic </td><td><span class="myFontBg" id="basicSl"></span></td><td></td></tr>
                    <tr><td style="width:40%">HRA </td><td><span class="myFontBg" id="hraAmt"></span></td><td></td></tr>
                    <tr><td style="width:40%">Travelling Allowance</td><td><span class="myFontBg" id="taAmt"></span></td><td></td></tr>
                    <tr><td style="width:40%">Dearness Allowance </td><td><span class="myFontBg" id="daAmt"></span></td><td></td></tr>
	                <tr><td style="width:40%">Personal Assistant </td><td><span class="myFontBg" id="paAmt"></span></td><td></td></tr>
                    <tr><td style="width:40%">Bonus </td><td><span class="myFontBg" id="bonus"></span></td><td></td></tr>
                    <tr><td style="width:40%">Medical Allowance </td><td><span class="myFontBg" id="medical"></span></td><td></td></tr>
                    <tr><td style="width:40%">Insentive </td><td><span class="myFontBg" id="insentive"></span></td><td></td></tr>
                    <tr><td style="width:40%">Other Income </td><td><span class="myFontBg" id="otherInc"></span></td><td></td></tr>
                    <tr><td style="width:40%">Provident Fund</td><td><span class="myFontBg" id="pfAmt"></span></td><td></td></tr>
                    <tr><td style="width:40%">Advance </td><td><span class="myFontBg" id="tdsAmt"></span></td><td></td></tr>
                    <tr><td style="width:40%">Insurance </td><td><span class="myFontBg" id="insurance"></span></td><td></td></tr>
                    <tr><td style="width:40%">Other Deduction </td><td><span class="myFontBg" id="othrDeduction"></span></td><td></td></tr>	
                    <tr><td style="width:40%">CTC </td><td><span class="myFontBg" id="grsAmt"></span></td><td></td></tr>
                  <!--<tr>
...
<script>
 const downloadButton = document.getElementById("downloadFrm");
        downloadButton.addEventListener('click', function()
		{
			...
			const options={margin:[5,5,5,5],filename:"download.pdf",image:{type: "jpeg", quality: 0.98 },html2canvas:{scale:2,letterRendering:true},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"}};
