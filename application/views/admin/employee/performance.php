											...
											<div class="main-contact-info-body">
                                               ...
                                               <div id="writeConversion">
                                              		<div class="ql-wrapper ql-wrapper-demo mb-3">
                                                        <label class="pstRemarks">Post Remark By Admin</label>
                                                        <div id="quillEditor">
                                                        </div>
                                                    </div>
...
$(document).ready(function()
 {
    ...
    reportBranch = { printTable: function(search_data) {getpaginate(search_data, '#perform_det', target, 'Only For Id,Employee Name.'); } }
