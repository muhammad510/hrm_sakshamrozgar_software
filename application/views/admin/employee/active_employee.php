...
<style>
  ...
  .amtltip .tlptext {
    visibility: hidden;
    width: 180px;
    background-color: rgba(0, 18, 19, 0.99);
    color: #fff;
    text-align: center;
    border-radius: 6px;
  ...
  .amtltip .tlptext::after {
    ...
    border-width: 5px;
    border-style: solid;
    border-color: rgba(0, 18, 19, 0.99) transparent transparent transparent;
  }

  .amtltip:hover .tlptext {
    visibility: visible;
  }
  ...
  .pstRemarks {
    color: #4636EE;
    font-weight: 700;
    background-color: #4636EE33;
    padding: 10px 10px 10px 10px;
    border: 1px solid #4636EE26;
  }
</style>
