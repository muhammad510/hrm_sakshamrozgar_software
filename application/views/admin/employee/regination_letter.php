            ...
            <div id="getPrfrmList">
             <div class="letter-container">
                 ...
                 <div style="text-align:justify">
                  <p>I hope this letter finds you in good health. I am writing to formally announce my resignation from my position as <span class="myFontBg empDesign"><span style="font-weight:400">_ _ _ _ _ _ _ _ _ _ _ _ _ _ _</span> </span> at <span class="myFontBg"><?php echo system_info('company_name') ?></span>, effective from _ _ _ _ _ _ _ _ _ _ _ _ _ _ _. After careful consideration, I have decided to pursue new opportunities that will allow me to grow both professionally and personally.</p>
                  <p>I would like to take this opportunity to express my gratitude to you and the entire <span class="myFontBg"><?php echo system_info('company_name') ?></span> team for the valuable experience and support during my tenure here. It has been a rewarding journey, and I have enjoyed working with such a talented group of individuals. I am thankful for the opportunities for growth and the professional relationships I have built along the way.</p>
                  ...
                  <p>Once again, I am grateful for the opportunities provided to me at <span class="myFontBg"><?php echo system_info('company_name') ?></span>. I wish the organization continued success in the future, and I look forward to staying in touch.</p>
                  </div>
