<div class="inner-body">
	...
	<style>
		...
		.miSecn {
			...
			padding: 10px;
			font-weight: 900;
			border-bottom: 1px solid #483ebd;
			color: #fff;
		}
								...
								<div class="row row-sm">
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control" name="uan" id="uan" placeholder="Enter UAN Here.." oninput="this.value=this.value.replace(/[^a-zA-Z0-9\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
...
<style>
	...
	#userPr ul li:last-child {
		border-bottom: 0px solid #000;
	}

	#amiResult {
		/*background-color:#f0f0f0;border: 1px solid #e3e2e3;*/
		margin-bottom: 15px;
