...
<div class="page-header">
	...
	.msp{padding: 8px 0px 0px 10px;}
	.miSlwdth4w{ width:87.32%}
	</style>
								...
								<div class="row row-sm">
                                    ...
                                    <div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control" name="father_name" id="father_name" placeholder="Enter Father Name Here.."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="aadharNu" id="aadharNu" class="form-control" placeholder="Enter Your Aadhaar Number"  oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g,'$1')" maxlength="12">
										</div>
									</div>
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="panNumber" id="panNumber" class="form-control" placeholder="Enter Your Pan Number" maxlength="10">
										</div>
									</div>                                   
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="nationality" id="nationality" class="form-control" placeholder="Enter Your Nationality Here.."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="reference_person_name" id="reference_person_name" class="form-control" placeholder="Enter Reference Person Name.."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="reference_person_number" id="reference_person_number" placeholder="Reference Person Mobile No... " class="form-control" maxlength="10" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
										</div>
									</div>
									<div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<!--<input type="text" placeholder="Qualification" name="qualification" id="qualification" class="form-control">-->
                                            <div class="miSlwdth4w">	
                                            <select name="qualification" id="qualification" class="form-control select2-with-search">
												<option value=""> --- Select One --- </option>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" placeholder="Work Exprience" name="work_exp" id="work_exp" class="form-control">
										</div>
									</div>
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="salary_amount" id="salary_amount" class="form-control"placeholder="Salary Amount..." oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
									...
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="holder_name" id="holder_name" class="form-control" placeholder="Enter Account Holder Name Here.."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
									<div class="col-md-4">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="bank_account_no" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')" id="bank_account_no" class="form-control" placeholder="Enter Account No. Here..">
										</div>
									</div>
									<div class="col-md-4">
									...
									<div class="col-md-6">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="bank_name" id="bank_name" class="form-control" placeholder="Enter Bank Name Here.."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
										</div>
									</div>
									<div class="col-md-6">
										<label>Branch :</label>
                          	  ...
                          	  <div class="row">
                              	<div class="col-lg-4 col-md-4">
                                	<div id="userPr" style="border-radius:1rem;">
                                      ...
                                      <ul>
                                      	<li><i class="fas fa-user radhe_2"></i></i>&nbsp;&nbsp;<span class="fontW">Employee Id</span> :-&nbsp;&nbsp;<span id="empRmemId" class="float-end">&nbsp;</span></li>
                                        <li><i class="fas fa-user radhe_2"></i>&nbsp;&nbsp;<span class="fontW">Employee Name</span> :-&nbsp;&nbsp;<span  class="float-end" id="empRname">&nbsp;</span></li>
                                        <li><i class="fas fa-mobile radhe_2"></i>&nbsp;&nbsp;<span class="fontW">Mobile No </span>:-&nbsp;&nbsp;<span  class="float-end" id="empRconNo">&nbsp;</span></li>
                                        <li><i class="fas fa-envelope radhe_2"></i>&nbsp;&nbsp;<span class="fontW">Email Id</span> :-&nbsp;&nbsp;<span  class="float-end" id="empRemail">&nbsp;</span></li>
                                        <li><i class="fas fa-key radhe_2"></i>&nbsp;&nbsp;<span class="fontW">Password</span> :-&nbsp;&nbsp;<span  class="float-end" id="empRshowPass">&nbsp;</span></li>
                                      </ul>
                                    </div>
                            	</div>
								...
								<!--*********************   Personal Details start  *********************  -->
                                  <div class="row">
									 <div class="miSecn_1" style="margin-top:0px;"> <i class="si si-user-follow"></i>&nbsp;&nbsp;Personal Details</div>
                                        <div class="col-md-6">
                                            <label>Father Name : </label>
                                            <span class="form-control msp" id="empRfname">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <label>Nationality : </label>
                                            <span class="form-control msp" id="empRnat">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <label>Refrence Person Name : </label>
                                            <span class="form-control msp" id="empRrePn">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <label>Reference Person Mobile No lll : </label>
                                            <span class="form-control msp" id="empRrefPerNo">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6 mt-2">
								...
								<!--*********************  company Details start  *********************  -->
								    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2"> 
                                            ...
                                            <span class="form-control msp" id="empRqua">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6 mt-2">
                                            <label>Work Exprience (In Month) : </label>
                                            <span class="form-control msp" id="empRworEx">&nbsp;</span>
                                        </div>
								    </div>
								<!--*********************  company Details end  *********************  -->
								<!-- ************************* Financial Details start **********************  -->
									<div class="row">
									 	<div class="miSecn" style="margin-top:20px;"> <i class="si si-user-follow"></i>&nbsp;&nbsp;Financial Details</div>
								      	<div class="col-md-6">
										    <label>Salary Type : </label>
											<span class="form-control msp" id="empRsalType">&nbsp;</span>
									</div>
                                      	<div class="col-md-6">
										<label>Salary Amount : </label>
										<span class="form-control msp"  id="empRsalAmo">&nbsp;</span>
									</div>									
								  	</div>
								<!-- ************************* Financial Details end **********************  -->
								<!-- *********************  Bank Account Details Start ********************  -->
								   <div class="row">
										<div class="miSecn" style="margin-top:20px;"> <i class="si si-user-follow"></i>&nbsp;&nbsp;Bank Account Details</div>
                                        <div class="col-md-6">
                                        <label>Account Holder Name : </label>
                                        <span class="form-control msp" id="empRholName">&nbsp;</span>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Account Number : </label>
                                            <span class="form-control" id="empRbanAccNo">&nbsp;</span>
                                        </div>
                                        <div class="col-md-4 mt-2">
                                            <label>IFSC Code : </label>
                                            <span class="form-control msp" id="empRifcCode">&nbsp;</span>
                                        </div>
                                        <div class="col-md-4 mt-2">
                                            <label>Bank Name : </label>
                                            <span class="form-control msp" id="empRbankNa">&nbsp;</span>
                                        </div>
                                        <div class="col-md-4 mt-2">
                                            <label>Branch : </label>
                                            <span class="form-control msp" id="empRbrancNa">&nbsp;</span>
                                        </div>
                                        <div class="col-md-12">
                               <a href="<?php echo base_url('admin/employee/add_employee');?>" class="btn ripple btn-outline-success pull-right" style="margin:15px auto -10px auto;">
