<style>
	.noteHead span{ font-weight:700; }.noteHead{ margin-bottom:20px;}.ami_tHeader {background-color: #088 !important;}.ami_tHeader > tr >th {border: 1px solid #088 !important;color: #fff;padding-left: 5px !important;}
	#saveDocDet{ margin-top:29px;}.table-responsive,#uplDocDetails {min-height: 150px !important;}
</style>
...
<div class="row row-sm" style="margin:15px -10px 15px -10px;">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header  border-0"> <h4 class="card-title">Employee Import</h4> </div> 
              <div class="card-body">
...
function readDoc()
{
    ...
    $.ajax({url:target,type:"POST",dataType:'json',beforeSend: function() { $('#readDocDet').html('<i class="fe fe-settings bx-spin"></i> Please Wait'); },
        	complete: function() { $('#readDocDet').html('<i class="ti-save"></i> Preview'); },success:function(htmlAmi){toastMultiShow(htmlAmi.addClas,htmlAmi.msg,htmlAmi.icon);},
   			 });
}
