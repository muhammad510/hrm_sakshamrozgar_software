...
<div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="card">
     <div class="card-header  border-0"> <h5 class="card-title">Rejected Employee</h5></div> 
     <div class="card-body">
     <div class="row row-sm">
...
$(function()
{
	...
	{
        $.ajax({
            url: '<?php echo base_url("admin/employee/resigned_employees"); ?>',
            type: 'POST',
            data: {page: page},
            dataType: 'json',
