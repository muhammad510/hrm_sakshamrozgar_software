...
.ami_tHeader > tr{border: 1px solid #088 !important;}
		#searchPayrolDetails,#newLeaveID,#amiLeaveAllChanges,#locTrgt{display:none;}
...
<div class="cardTtl">
	...
	<div class="row row-sm">
		<div class="cardTtl">
			<div class="miHeader">
				<span class="miLst"><i class="ti-briefcase"></i><span id="bxTitleNm"><?php echo $title;?></span></span>
           		...
           		<form method="post" id="add_leaveDetails"> 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control ojArv" name="leaveNwName" id="leaveNwName">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                             ...
                             <input type="text" class="form-control ojArv" name="leaveNoDays" id="leaveNoDays"> 
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row row-sm" id="vTbleShw">
