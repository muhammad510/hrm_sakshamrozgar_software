...
<div id="viewProDet">
  <div class="row">
    <?php if($employee->gender=='1'){$genIcn='si si-user';}else if($employee->gender=='2'){$genIcn='si si-user-female';}else{$genIcn='si si-emotsmile';}?>
    <div class="col-md-12">
          ...
          <div class="miSlwdth">
            <select name="state" id="state" class="form-control select2-with-search arvChange">
              <option label="Select State"></option>
				<?php if($getState){foreach($getState as $stD){?>
              <option value="<?php echo $stD->id;?>" <?php if($employee->state==$stD->id){echo 'selected="selected"';}?> > <?php echo $stD->state_cities;?> </option>
              <?php }}?>
            </select>
          </div>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <div class="miSlwdth">
            <select name="district" id="district" class="form-control select2-with-search arvChange">
              ...
              <?php if($getCity){foreach($getCity as $distrct){?>
              <option value="<?php echo $distrct->id;?>"<?php if($employee->district==$distrct->id){echo 'selected="selected"';}?> > <?php echo $distrct->state_cities;?> </option>
              <?php }}?>
            </select>
          </div>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <div class="miSlwdth">
            <select name="marital_status" id="marital_status" class="form-control select2-with-search">
              ...
              <option value="2" <?php if($employee->marital_status=='2'){echo 'selected="selected"';}?>>Un Married</option>
            </select>
          </div>
        </div>
      </div>
