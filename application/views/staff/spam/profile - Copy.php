						...
						<div class="card-body">
							...
							<div class="profile-tab tab-menu-heading">
								<nav class="nav main-nav-line p-3 tabs-menu profile-nav-line bg-gray-100">
									...
									<a class="nav-link" data-bs-toggle="tab" href="#settings">Account Settings</a>											</nav>
							</div>
						</div>
					</div>
				</div>
												...
												<div class="col-12">
													<div class="card mg-b-20 border">
														...
														<div class="card-body">
															...
															<div class="row row-sm">
																<div class="col"> <img alt="img" class="wd-200 me-4 mt-2" src="../assets/img/media/1.jpg"> <img alt="img" class="wd-200 mt-2" src="../assets/img/media/2.jpg"> </div>
															</div>
													...
													<div class="card mg-b-20 border">
														...
														<div class="card-body h-100">
															<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
															<div class="row row-sm">
																<div class="col"> <img alt="img" class="wd-200 me-4 mt-2" src="../assets/img/media/4.jpg"> <img alt="img" class="wd-200 mt-2" src="../assets/img/media/5.jpg"> </div>
															</div>
															<div class="media mg-t-15 profile-footer">
																<div class="media-user me-2">
																	<div class="demo-avatar-group">
																		<div class="demo-avatar-group main-avatar-list-stacked">
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/12.jpg"></div>
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/7.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/2.jpg"></div>
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/5.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/6.jpg"></div>
																			<div class="main-avatar"> +23 </div>
																		</div>
														...
														<div class="card-body h-100">
															...
															<div class="media mg-t-15 profile-footer">
																<div class="media-user me-2">
																	<div class="demo-avatar-group">
																		<div class="demo-avatar-group main-avatar-list-stacked">
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/12.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/3.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/4.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/9.jpg"></div>
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/10.jpg"></div>
																			<div class="main-avatar"> +23 </div>
																		</div>
																		<!-- demo-avatar-group -->
																	</div>
													...
													<div class="card border">
														<div class="card-header p-4">
															<div class="media">
																<div class="media-user me-2">
																	<div class="main-img-user avatar-md"><img alt="" class="rounded-circle" src="../assets/img/users/2.jpg"></div>
																</div>
																<div class="media-body">
																	<h6 class="mb-0 ms-2 mg-t-3">Mintrona Pechon Pechon</h6><span class="text-muted ms-2">Sep 26 2019, 10:14am</span> </div>
																<div class="ms-auto">
														...
														<div class="card-body h-100">
															<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
															<div class="row row-sm">
																<div class="col"> <img alt="img" class="wd-200 me-3 mt-2" src="../assets/img/media/4.jpg"> <img alt="img" class="wd-200 mt-2" src="../assets/img/media/7.jpg"> </div>
															</div>
															<div class="media mg-t-15 profile-footer">
																<div class="media-user me-2">
																	<div class="demo-avatar-group">
																		<div class="demo-avatar-group main-avatar-list-stacked">
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/11.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/12.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/3.jpg"></div>
																			<div class="main-img-user"><img alt="" class="rounded-circle" src="../assets/img/users/4.jpg"></div>
																			<div class="main-img-user online"><img alt="" class="rounded-circle" src="../assets/img/users/5.jpg"></div>
								...
								<div class="card-body border">
									<div class="demo-gallery">
										<ul id="lightgallery" class="list-unstyled row row-sm">
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/1.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/1.jpg" data-sub-html="<h4>Gallery Image 1</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4 wd-100p" src="../assets/img/media/1.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/2.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/2.jpg" data-sub-html="<h4>Gallery Image 2</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4" src="../assets/img/media/2.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/3.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/3.jpg" data-sub-html="<h4>Gallery Image 3</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4" src="../assets/img/media/3.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/4.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/4.jpg" data-sub-html="<h4>Gallery Image 4</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4" src="../assets/img/media/4.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/5.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/5.jpg" data-sub-html="<h4>Gallery Image 5</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4" src="../assets/img/media/5.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/6.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/6.jpg" data-sub-html="<h4>Gallery Image 6</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4" src="../assets/img/media/6.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/7.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/7.jpg" data-sub-html="<h4>Gallery Image 7</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../assets/img/media/7.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/8.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/8.jpg" data-sub-html="<h4>Gallery Image 8</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../assets/img/media/8.jpg" alt="Thumb-1"> </a>
											</li>
											<li class="col-sm-6 col-lg-4" data-responsive="https://php.spruko.com/spruha/spruha/assets/img/media/9.jpg" data-src="https://php.spruko.com/spruha/spruha/assets/img/media/9.jpg" data-sub-html="<h4>Gallery Image 9</h4>">
												<a href="javascript:void(0);" class="wd-100p"><img class="img-responsive mb-4 mb-lg-0" src="../assets/img/media/9.jpg" alt="Thumb-1"> </a>
											</li>
										</ul>
										<!-- /Gallery -->
									</div>
											...
											<div class="card custom-card border">
												<div class="card-body text-center">
													<div class="user-lock text-center">
														...
														<a href="profile.html"><img alt="avatar" class="rounded-circle" src="../assets/img/users/4.jpg"></a>																	</div>
													<a href="profile.html"><h5 class="mb-1 mt-3 main-content-label">Owen Bongcaras</h5></a>
													<p class="mb-2 mt-1 tx-inverse">App Developer</p>
													<p class="text-muted text-center mt-1">Lorem Ipsum is not simply popular belief Contrary.</p>
												</div>
									...
									<form class="form-horizontal" data-select2-id="11">
										...
										<div class="form-group ">
											<div class="row row-sm">
												...
												<div class="col-md-10"> <a class="me-2" href="javascript:void(0);">Deactivate Account</a> <a class="me-2" href="javascript:void(0);">Change Password</a> </div>
											</div>
										</div>
									</form>
								</div>
