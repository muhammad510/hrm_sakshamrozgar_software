	...
	<div class="row row-sm">
		<div class="cardTtl">
			<div class="miHeader">
				...
				<span class="miBck"><a href="<?php echo base_url('software/shift/add_shift');?>" title="Add New Shift"><i class="ti-plus"></i></a></span>
			</div>
			...
			<!-- View Shift Modal Start -->
			<!-- <div class="modal fade" id="view_shift_modal">
			...
			<div class="modal" id="view_shift_modal">
				<div class="modal-dialog modal-md" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Shift Details</h6>
			...
			<!-- View Shift Modal End-->

            <!-- Update Shift Modal Start -->
			<div class="modal" id="update_shift_modal">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Update Shift Details</h6>
							<button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
						</div>
						<form id="shift_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
							<div class="modal-body">
								<div id="up_shift"></div>
							</div>
    						...
    						<button class="btn ripple btn-outline-success pull-right" type="submit" id="shiftdataupdate"><i class="ti-save"></i>&nbsp;&nbsp;Save changes</button>
    						</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="delMsg"><i class="fe fe-sliders"></i> Shift Status</div>
