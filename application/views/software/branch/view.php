		...
		<div class="cardTtl">
			...
			<div class="col-md-12 ">
				...
				<div class="row row-sm">
                    ...
                    <input type="hidden" id="id" value="<?php echo $getBranch->id; ?>" />
                	<div class="col-6">
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-group mb-3">
                           ...
                           <div class="miSlwdth" style="width:88.38%"> 
							 <select class="form-control custom-select select2 empSelectR" name="state" id="state">
                    ...
                    <div class="col-4">
                        ...
                        <div class="input-group mb-3">
                           ...
                           <div class="miSlwdth" style="width:88.38%"> 
							 <select class="form-control custom-select select2 " name="district" id="district">
                              <option value=""> --- Select Dsitrict --- </option>
                                <?php if($getDistrict){foreach($getDistrict as $district){?>   
                                  <option value="<?php echo $district->id;?>" <?php if($getBranch){if($district->id==$getBranch->district){ echo 'selected="selected"';}} ?> >
