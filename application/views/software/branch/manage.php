               ...
               <form method="post" id="manage_branch" data-id="<?php echo $oprLocTrgt;?>"> 
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="brLatitude" id="brLatitude" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')">
                        </div>
                    </div>
                    	<div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text miClr"><i class="fa fa-map-marker"></i></i></span>
                            </div>
                            <input type="text" class="form-control" name="brLongitude" id="brLongitude" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')">
                        </div>
                    </div>
                   	</div>
                    <div class="row row-sm">
                        ...
                        <div class="col-md-6">
                            <label>Designation:<input type="hidden" id="getDesigIdFr" name="getDesigIdFr" value=""/></label>
                            <div class="input-group mb-3" style="height:63px;">
                                <div class="input-group-prepend">
		...
		if($('#'+curentID).hasClass('depActve'))
		{
			...
			else if(crntDiv[0]=='desig')
			{
				...
				if($('#'+curentID).hasClass('depActve'))
				{
					...
					{
						if(getDesigIdFr!=""){optedDetails=getDesigIdFr+","+crntDiv[1];$('#getDesigIdFr').val(optedDetails);}
						else{$('#getDesigIdFr').val(crntDiv[1]);}
						$('#'+curentID).addClass('depActve');$("#adDesigMrk--"+crntDiv[1]).addClass('mrkAdd').html(getCheckMrk);
						}		
						$('#desigSelct').css('color','#2C6377').html('<i class="fe fe-sun bx-spin"></i> Please Wait...');		
						$.post(getResourceLoc,{id:$('#getDesigIdFr').val()}, function(htmlAmi)
						{
