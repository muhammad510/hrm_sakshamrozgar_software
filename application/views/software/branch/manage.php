<div class="inner-body">
    ...
    <div class="page-header">
        ...
        <div class="d-flex">
            <div class="justify-content-center">
                <a href="<?php echo base_url('staff/dashboard');?>" class="btn btn-success btn-icon-text my-2 me-2"
                    title="Dashboard"> <i class="ti-home"></i> Dashboard </a>
                <button type="button" class="btn btn-primary btn-icon-text my-2 me-2" id="miArvClk"> <i
                        class="fe fe-filter me-2"></i> Current Time </button>
                <a href="<?php echo base_url('auth/login/signout');?>" class="btn btn-danger btn-icon-text  my-2 me-2">
                    <i class="fe fe-power me-2"></i> Sign Out </a>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
    ...
    .dataTables_processing {
        background-color: #EBC7A0 !important;
        color: #874921 !important;
    }

    .depDesig {
        margin: -39.5px 0px 23.5px 39px !important;
        width: 100%;
    ...
    .depDesig-drop ul li span {
        padding: 2px 10.25px 2px 10.25px;
            ...
            <form method="post" id="search_branch">
                <div class="col-md-12">
                    <div class="row row-sm">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="miSlwdth" style="width:92.33%">
                                    <select class="form-control select2-with-search" name="state" id="state">
                                        ...
                                        <option value="<?php echo $state->id;?>"><?php echo $state->state_cities;?>
                                        </option>
                                        <?php }}?>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="javascript:void(0)" class="btn ripple btn-outline-dark branchManage" id="bkSrch"><i
                                    class="fe fe-arrow-left"></i> Back</a>
                            <button class="btn ripple btn-outline-success pull-right"
                                onclick="return get_search(reportBranch,'#search_branch','#branch_det')">
    ...
    <div class="row row-sm">
        <div class="cardTtl">
            <div class="miHeader">
                ...
                <span class="miBck">
                    <a href="javascript:void(0);" style="margin-left:-5px;" title="Click to search branch details"
                        class="miDefault branchManage" id="branchSrch">
                        <i class="ti-search"></i>
                    </a>
                </span>
                <span class="miBck">
                    <a href="javascript:void(0);" style="margin-left:-5px;" title="Click to add branch details"
                        class="miDefault branchManage" id="addNewBranchDetails" data-id="<?php echo $addBranch;?>">
                        <i class="ti-plus"></i>
                    </a>
                </span>
            </div>
                        ...
                        <form method="post" id="manage_branch" data-id="<?php echo $oprLocTrgt;?>">
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text"  name="gtBrCode" id="gtBrCode"
                                            class="form-control" value="<?php echo $newBranchID;?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="brNwName" id="brNwName"
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text miClr"><i class="fa fa-link"></i></span>
                                        </div>
                                        <input type="text" name="brLatitude" id="brLatitude" class="form-control"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text miClr"><i
                                                    class="fa fa-map-marker"></i></i></span>
                                        </div>
                                        <input type="text" class="form-control" name="brLongitude" id="brLongitude"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')">
                                    </div>
                                </div>
                            </div>
                            <div class="row row-sm">
                                <div class="col-md-6">
                                    <label>Department:<input type="hidden" id="getDepIdFr" name="getDepIdFr"
                                            value="" /></label>
                                    <div class="input-group mb-3" style="height:63px;">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text miClr"><i
                                                    class="si si-organization"></i></span>
                                        </div>
                                        <div class="depDesig" id="department">
                                            <div class="depSelct" id="depSelct"> Select Department</div><span
                                                id="getCheckMrk">&#10003;</span>
                                    ...
                                    if($getDepartment)
                                    {
                                        foreach($getDepartment as $dep)
                                        {
										   ...
										   $liUrlActn=base_url('software/branch/administration/department');
                                            ?>
                                                <li id="dept--<?php echo $depID;?>" data-id="<?php echo $liUrlActn;?>"
                                                    class="depCollect">
                                ...
                                <div class="col-md-6">
                                    <label>Designation:<input type="hidden" id="getDesigIdFr" name="getDesigIdFr"
                                            value="" /></label>
                                    <div class="input-group mb-3" style="height:63px;">
                                        <div class="input-group-prepend">
                            ...
                            <div class="row row-sm">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="contactNu" id="contactNu"
                                            maxlength="10"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text miClr"><i
                                                    class="si si-screen-smartphone"></i></span>
                                        </div>
                                        <input type="text" id="mobileNu" maxlength="10"
                                            oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')"
                                            name="mobileNu" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea class="form-control" name="brAddress" id="brAddress" rows="2"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="miSlwdth" style="width:88.38%">
                                            <select class="form-control select2-with-search empSelectR" name="get_state"
                                                id="get_state">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="miSlwdth" style="width:88.38%">
                                            <select class="form-control select2-with-search " name="district"
                                                id="district">
                                ...
                                <div class="col-md-12">
                                    <a href="javascript:void(0)" class="btn ripple btn-outline-dark branchManage"
                                        id="bkSrch_01">
                                        <i class="fe fe-arrow-left"></i> Back</a>
                                    <button class="btn ripple btn-outline-success pull-right" id="manage"><i
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        style="float:right;"><i class="si si-close"></i></button>
                    <div class="delMsg"><i class="fe fe-sliders"></i> Branch Status</div>
                    <div class="actnData"><i class="si si-power"></i> Are you sure want to activate of Branch ID #F33333
                    </div>
                    <div id="mdlFtrBtn">
                        <button type="button"
                            class="btn btn-outline-secondary waves-effect waves-light pull-right getAction"
                            id="cnfChanges" data-id="@misingh143">
    ...
    $(function() {
        $(document).on("click", '.depCollect', function() {
            ...
            if (crntDiv[0] == 'dept') {
                ...
                if ($('#' + curentID).hasClass('depActve')) {
                    $('#' + curentID).removeClass('depActve');
                    $("#adMrk--" + crntDiv[1]).html('').removeClass('mrkAdd');
                    if (getDepIdFr != "") {
                        let firstDt = getDepIdFr.substring(0, 1);
                        if (getDepIdFr == crntDiv[1]) {
                            optedDetails = '';
                        } else if (firstDt == crntDiv[1]) {
                            optedDetails = getDepIdFr.replace(crntDiv[1] + ',', '');
                        } else {
                            optedDetails = getDepIdFr.replace(',' + crntDiv[1], '');
                        }
                    ...
                    if (getDepIdFr != "") {
                        optedDetails = getDepIdFr + "," + crntDiv[1];
                        $('#getDepIdFr').val(optedDetails);
                    } else {
                        $('#getDepIdFr').val(crntDiv[1]);
                    }
                    $('#' + curentID).addClass('depActve');
                    $("#adMrk--" + crntDiv[1]).addClass('mrkAdd').html(getCheckMrk);
                }
                let crntOptedID = $('#getDepIdFr').val();
                $('#depSelct,#desigSelct').css('color', '#2C6377').html(
                ...
                $('#desigSelct').css('color', '#2C6377').html(
                    '<i class="fe fe-sun bx-spin"></i> Please Wait...');
                let optedClick = '';
                if ($('#' + curentID).hasClass('depActve')) {
                    $('#' + curentID).removeClass('depActve');
                    $("#adDesigMrk--" + crntDiv[1]).html('').removeClass('mrkAdd');
                    if (getDesigIdFr != "") {
                        let firstDt = getDesigIdFr.substring(0, 1);
                        if (getDesigIdFr == crntDiv[1]) {
                            optedDetails = '';
                        } else if (firstDt == crntDiv[1]) {
                            optedDetails = getDesigIdFr.replace(crntDiv[1] + ',', '');
                        } else {
                            optedDetails = getDesigIdFr.replace(',' + crntDiv[1], '');
                        }
                    ...
                    if (getDesigIdFr != "") {
                        optedDetails = getDesigIdFr + "," + crntDiv[1];
                        $('#getDesigIdFr').val(optedDetails);
                    } else {
                        $('#getDesigIdFr').val(crntDiv[1]);
                    }
                    $('#' + curentID).addClass('depActve');
                    $("#adDesigMrk--" + crntDiv[1]).addClass('mrkAdd').html(getCheckMrk);
                }
                $('#desigSelct').css('color', '#2C6377').html(
                    '<i class="fe fe-sun bx-spin"></i> Please Wait...');
                $.post(getResourceLoc, {
        ...
        $(document).ready(function() {
            ...
            $('.depDesig').mouseenter(function() {
                let curentDiv = $(this).attr('id');
                $("#opn--" + curentDiv).show();
            });
            $('#hoverDiv').mouseleave(function() {
                let curentDiv = $(this).attr('id');
                $("#opn--" + curentDiv).fadeOut();
            });
            $(document).click(function(event) {
                if (!$(event.target).closest('#depSelct,#desigSelct').length) {
                    $('#opn--department').fadeOut();
                    $('#opn--gtDeisgnation').fadeOut();
                }
            });
