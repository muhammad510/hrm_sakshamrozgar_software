<div class="inner-body">                       
	...
	<div class="page-header">
		<div>
			<h2 class="main-content-title tx-24 mg-b-5">Designation</h2>
			<ol class="breadcrumb">
	...
	<div class="row row-sm">
		<div class="cardTtl">
			<div class="miHeader">
				...
				<span class="miBck"><a href="javascript:void(0);"data-bs-target="#add_designation_modal" data-bs-toggle="modal" style="margin-left:-5px;" title="Click to Add Designation Details" class="miDefault"><i class="ti-plus"></i></a></span>
			</div>
			<div class="col-md-12 col-lg-12">
			<input type="hidden" id="designation" value="<?php echo $designation;?>" />	
			<div class="row row-sm" id="amiResult">
				<table class="table text-nowrap text-md-nowrap table-striped table-bordered table-hover mg-b-0" id="designation_list">
			...
			<div class="modal" id="add_designation_modal" data-bs-backdrop="static">
				<div class="modal-dialog modal-md" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Add New Designation Details</h6>
						...
						<form id="add_designation_data" method="post" accept-charset="utf-8" enctype="multipart/form-data">
							<div class="modal-body">
                                <div class="row row-sm">
                                  ...
                                  <div class="col-12">
                                        <span id="desigNm" class="regiErr">SoftArena</span>
                                        <label>Designation Name:<span class="text-danger">*</span></label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-briefcase"></i></span>
                                            </div>
                                            <input type="text" class="form-control" name="designation_name" id="designation_name" placeholder="Enter Designation Name..."  oninput="this.value=this.value.replace(/[^a-zA-Z\s]/g,'').replace(/\s+/g,' ')">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                             ...
                                             <select class="form-control" name="priority" id="priority">
                                                ...
                                                <option value="Lowest" selected="selected">Low</option>
											</select>
                                        </div>
                                    </div>
                                    <div class="col-12">
							...
							<div class="modal-footer">
                                ...
                                <button class="btn ripple btn-outline-success" type="submit" id="designationdata"><i class="ti-save"></i> Submit</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="modal" id="update_designation_modal"  data-bs-backdrop="static">
				<div class="modal-dialog modal-md" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Update Designation Details</h6>
							<button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">x</span></button>
						</div>
						<form id="designation_updata" method="post" accept-charset="utf-8" enctype="multipart/form-data">
							...
							<div class="modal-footer">
    						<button class="btn ripple btn-outline-dark" data-bs-dismiss="modal" type="button"><i class="fe fe-arrow-left"></i> Back</button>
    						<button class="btn ripple btn-outline-success pull-right" type="submit" id="designationupddata"><i class="ti-save"></i> Save changes</button>
    						</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="delMsg"><i class="fe fe-sliders"></i> Designation Status</div>
                    <div class="actnData"><i class="si si-power"></i>  Are you sure want to activate of Designation ID #F33333</div>
                    <div id="mdlFtrBtn">
...
<script src="<?php echo base_url() ?>assets/js/setting/designation.js"></script>