<div class="inner-body">                       
	<style>
.inrGrn i{ font-size:.75rem; color:#02aa73}.inrBlue i{ font-size:.75rem; color:#0283aa}.inrRed i{ font-size:.75rem; color:#cc5d1a}.form-control[readonly]{background-color: #fff !important;}
.miForm-control{width:60px !important;margin-right:5px;display:block;height:calc(1.5em + 0.75rem + 2px);padding:0.175rem .4rem 0.175rem 0.4rem;font-size:0.875rem;font-weight:400;line-height:1.5;color: #0D3E73;background-color:#ffffff;background-clip:padding-box;border:1px solid #e8e8f7;border-radius:3px;transition:border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;height:38px;border-radius:5px;border-top-left-radius:5px;border-bottom-left-radius:5px;}.miForm-control:focus{color:#42617F;background-color:#fff;border-color:#e8e8f7;outline:0;}.miBck a:hover{ background-color:#645bca; color:#fff;}.miBck{ font-weight:600;text-transform: uppercase; float:right;margin-right: 10px;padding-top: 7px;}.miBck a{ border:1px solid #645bca;padding: 8px 12px 8px 12px;border-radius: 5px;color: #645bca;font-weight: bold;}.miLst{ font-weight:600;text-transform: uppercase;}.miLst i{ background-color: #645bca;padding: 11px 11px 10px 10px ;margin-right: 10px;border-radius: 20px;color: #fff;font-weight: bold;}
.miHeader{padding:10px 15px 10px 15px;border-bottom: 1px solid #cccece;margin: 0px -10px 20px -10px;border-top-left-radius: 5px;border-top-right-radius: 5px;}.cardTtl{border:1px solid #fff;padding:0px 0px 40px 0px;margin-bottom: 75px;border-radius: 5px;background-color: #fff;}.ami_tHeader > tr > th{ color:#FFFFFF !important;border: 1px solid #088 !important;padding: 12px 0px 12px 5px !important;}.ami_tHeader > tr{border: 1px solid #088 !important;}#searchBranchDetails,#adBtnActn,#getSalaryDet{display:none;}.pyDet{border-left:1px solid #45545436;border-right: 1px solid #45545436;}.pyHdr{color: #009966;padding: 10px;font-weight: bold;text-transform: uppercase;border-top: 3px solid #096;background-color: #ddffea45;margin: 0px -1px 0px -1px;}.pyDeduHdr{color: #993200;padding: 10px;font-weight: bold;text-transform: uppercase;border-top: 3px solid #993200;background-color: #9932000a;margin: 0px -1px 0px -1px;}.pyListDet { list-style:none; padding-left:0px !important;margin-bottom: 0px;}.pyListDet li{ padding:10px 20px 10px 10px;border-bottom: 1px dashed #1f74bf;color: #04559d; }.pyListDet li:last-child{ border-bottom:0px;font-weight: bold;background-color: #a0f4fd4d;}.mStrong{ font-weight:600; float:right; color:#1a8c03;}.mDedStrong{font-weight:600; float:right; color:#036e8e;}.pyListDeduDet { list-style:none; padding-left:0px !important;margin-bottom: 0px;}.pyListDeduDet li{ padding:10px 20px 10px 10px;border-bottom: 1px dashed #bf451f;color: #9d7004; }.pyListDeduDet li:last-child{ border-bottom:0px;font-weight: bold;background-color: #ffe3bc;}.pyDed{border:1px solid #45545436; border-top:0px;}.netPyble{background-color: #a3fda01c; padding: 10px 20px 10px 10px; margin-bottom: 10px; border: 1px solid #45545436;text-align: right;text-transform: uppercase;font-weight: bold;color: #464646;}.txtFrm{padding:15px 10px 15px 10px;background-color:#C1C1C13D;text-transform:uppercase;font-weight:bold;color:#646464;border:1px solid #645BCA29;margin-bottom:15px;}	.salaryID{padding:15px 10px 15px 10px;background-color:#C1C1C13D;text-transform:uppercase;font-weight:bold;color:#646464;border:1px solid #645BCA29;margin-bottom:15px;}	#vSalCode{ color:#645BCA;}.txtFrm span{ float:right;text-transform: capitalize; color:#645BCA}	#netPaybleSalAmt,#empCtC{ color:green;}.createBy{background-color:#0099CC12;margin-top: 20px;padding: 10px;color: #393939;border: 1px solid #0099CC45;}.createDt{padding:10px; background-color:#0099CC12;color: #393939;border: 1px solid #0099CC45;}.crSpan{ font-weight:bold;float: right; padding-right: 10px;color: #0080AA;}
.modifyDt{padding:10px; background-color:#ffff0042;color: #393939;border: 1px solid #dddd05d1;}.mdSpan{ font-weight:bold;float: right;padding-right: 10px;color: #797900d1}  .updateBy{background-color:#ffff0042;margin-top: 20px;padding: 10px;color: #393939;border: 1px solid #dddd05d1;}.input-group-text i{ color:#06a470;}.miSlwdth{width:92.33%}.miLvs{ padding:5px 12px 5px 12px;}.delMsg {text-align: center;font-size: 20px;margin: 30px 0px 10px 0px;color :#00805c;}.actnData {text-align: center;margin: 0px 0px 20px 0px;color: #716c6c;font-size: .8rem;}.delMsg i{ background-color: #00805c;padding: .5rem;font-size: .75rem;border-radius: .5rem;color: #fff;}
	</style>
                        ...
                        <div class="input-group mb-3">
                           ...
                           <div class="miSlwdth" style="width:92.33%"> 
							   <select class="form-control select2-with-search arvOnChange" name="searchTyp" id="searchTyp">
									...
									<?php if($desigList){foreach($desigList as $desig){?>
                    ...
                    <div class="col-md-12">
                   		<div class="netPyble">NET Payable : 
                        	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-currency-rupee" viewBox="0 0 16 16">
  								<path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4z"/></svg><span id="netPaybleSalAmt">------</span></div>
                   </div>
                   <div class="col-md-12">
                   		<div class="netPyble" style="margin-top:-10px;border-top: 0px;">CTC : 
                        	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-currency-rupee" viewBox="0 0 16 16">
  								<path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4z"/></svg><span id="empCtC">------</span></div>
                   </div>
                    <div class="col-md-12">
            	...
            	<table class="table text-nowrap text-md-nowrap table-striped table-bordered table-hover mg-b-0" id="branch_det">
					<thead class="ami_tHeader">
                        <tr>
                            ...
                            <th><div style="width:80px;">SAL CODE</div></th>
                            <th>Branch</th>
                            <th>DESIGNATION</th>
                            <th><div style="width:140px;">GROSS SALARY AMT.</div></th>                            
                            <th>DEDUCTION</th>
   ...
   <div  id="vCreateNew" style="display:none;">
        ...
        <div class="col-6">
            ...
            <div class="input-group mb-3">
              ...
              <div class="miSlwdth">    
                 <select class="form-control select2-with-search arvSel" name="brOffice" id="brOffice" data-id="<?php echo $getDesignation;?>">
                     <option value=""> --- Select One --- </option>
                     <?php if($branchList){foreach($branchList as $branch) {?>
                     <option value="<?php echo $branch->id;?>"><?php echo $branch->branch_name;?></option>
                     <?php }}else{?><option value="">No branch available</option><?php }?>
                </select>
              </div>  
            </div>
        </div>
        ...
        <div class="col-6">
          <div class="pyDetails">
            ...
            <div class="row">
                 <div class="col-12"><label>Gross Salary:<span class="text-danger">*</span></label><div class="input-group mb-3">
...
<style>
.miDeduction i{ color:#b96600;}
.pyDetails i{ color:#016a2d;}
.pyDetails{background-color:#E0F2C969; padding:10px; border:1px solid #D3EAB73B; margin-bottom:20px;}
.miDeduction{background-color:#ffebd357; padding:10px; border:1px solid #ffebd391; margin-bottom:20px;}
